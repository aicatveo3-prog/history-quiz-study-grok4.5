// Grok 생성 제1편 (선사 시대) — 틀만 준비. 한능검 자료 업로드 후 문항·이론·체크리스트 채움.
...
(function () {
  ...
  var THEORY = [
    {
      blocks: [
        { k: "lead", t: "Grok 생성 제1편 (선사 시대) — 자료 업로드 후 이론정리를 채울 예정입니다." },
        { k: "sec", t: "1-1 준비 상태" },
        { k: "p", t: "한능검 심화 기출·학습 자료를 GitHub materials/한능검-업로드/ 경로에 올리면, 규칙(CLAUDE.md)에 따라 OX 퀴즈·이론·체크리스트를 생성합니다." },
        { k: "note", v: "tip", title: "다음 단계", t: "정답표 + 문제 원문 파일을 업로드한 뒤 채팅에서 「Grok 제1편 생성」을 요청하세요." }
      ]
    }
  ];
